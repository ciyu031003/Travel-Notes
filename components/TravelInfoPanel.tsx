...
export default function TravelInfoPanel({
  ...
  return (
    <aside
      className="relative w-full max-w-sm flex flex-col gap-4 p-5 rounded-3xl border border-[#D6E8F0]/70 bg-[#FAFBF7]/85 backdrop-blur-md shadow-[0_12px_40px_-12px_rgba(90,102,112,0.18)]"
