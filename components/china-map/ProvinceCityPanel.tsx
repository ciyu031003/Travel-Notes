...
export default function ProvinceCityPanel({
  ...
  return (
    <div className="absolute top-0 right-0 bottom-0 w-[min(380px,100%)] bg-travel-cream/97 backdrop-blur-md border-l border-travel-dim/60 shadow-[-12px_0_40px_-8px_rgba(90,102,112,0.12)] flex flex-col z-30 animate-[slideIn_0.3s_ease-out]">
      <style>{`
        @keyframes slideIn {
      ...
      <div className="flex items-center justify-between p-4 border-b border-travel-dim/60">
      ...
      {posts.length > 0 && (
        <div className="p-4 bg-gradient-to-br from-travel-sakura/30 to-travel-mist/30 border-b border-travel-dim/60">
