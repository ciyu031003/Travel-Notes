export default function MapLegend() {
  return (
    <div data-map-overlay className="absolute bottom-4 right-4 flex items-center gap-3 rounded-lg border border-travel-dim/80 bg-travel-cream/85 px-2 py-1.5 md:px-4 md:py-2 text-xs text-travel-ink backdrop-blur">
